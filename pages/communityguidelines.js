    ...
    <>
      ...
      <section className="container p-6 md:p-0 gap-8 mx-auto flex flex-col mb-12 justify-center pt-12">
        ...
        <div className="font-primary300 text-[15px] md:text-lg">
          ...
          others. Our team of moderators and automated systems work together to
          ensure that users who violate these community guidelines may face
          consequences.
        </div>
        <div className="font-primary300 text-[15px] md:text-lg">
          At Cube, we encourage free expression as long as it doesn&apos;t harm
          or offend others. To maintain a safe and welcoming community, we
          require everyone to follow these guidelines both on and offline and
        ...
        <div className="font-primary300 text-[15px] md:text-lg">
          <span className="font-primary400">Minors: </span>Cube is for users who
          are 18 years of age or older. We don&apos;t allow images of
        ...
        <div className="font-primary300 text-[15px] md:text-lg">
          ...
          tolerate any targeted abuse or harassment against any user, including
          sending unsolicited sexual content to matches. Reports of stalking,
          threats, bullying, or intimidation are taken seriously.
        </div>
        <div className="font-primary300 text-[15px] md:text-lg">
          <span className="font-primary400">Violence and physical harm:</span>
          We don&apos;t allow violent, graphic, or gory content on Cube, or any
          actions or content that promote or threaten violence, including
          terrorism.
        </div>
        <div className="font-primary300 text-[15px] md:text-lg">
        ...
        <div className="font-primary300 text-[15px] md:text-lg">
          <span className="font-primary400">Private information : </span>Please
          refrain from sharing any private information such as social security
          numbers, passports, passwords, financial information, or unlisted
          contact information like phone numbers, email addresses, home/work
          addresses.
        </div>
        <div className="font-primary300 text-[15px] md:text-lg">
          <span className="font-primary400">Spam: </span>Don&apos;t use Cube to
          drive people to external websites via a link or otherwise.
        </div>
        <div className="font-primary300 text-[15px] md:text-lg">
        ...
        <div className="font-primary300 text-[15px] md:text-lg">
          <span className="font-primary400">Scamming: </span> Anyone attempting
          to get other users&apos; private information for fraudulent or illegal
          activity may be banned. Sharing financial account information (PayPal,
          Venmo, etc.) for the purpose of receiving money from other users is
          also prohibited.  
        </div>
        ...
        <div className="font-primary300 text-[15px] md:text-lg">
          <span className="font-primary400">Third-party apps : </span>The use of
          any third-party apps that claim to offer our service or unlock special
          Cube features, like auto-swipers, is not allowed.
        </div>
        <div className="font-primary300 text-[15px] md:text-lg">
          Thank you for being considerate and abiding by our community
          guidelines. If you encounter any behavior that violates these
          guidelines or have any questions, please don&apos;t hesitate to report
          it to our moderation team.
        </div>
      </section>
      <Footer />
    </>
