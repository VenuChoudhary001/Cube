...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    t4.from(root.current.children[3], { css: { x: -1250 } }, "start+=1.2").to(
        ...
        <main ref={root} className="max-w-[800px] mx-auto flex flex-col gap-5">
          ...
          <div className=" flex relative justify-between">
            <img
              src="/home/3.svg"
              alt=""
              className=" w-[238px] 2xl:w-[280px]  h-[230px] 2xl:h-[280px]  2xl:-mt-[58px] -mt-[44px] ml-[70px] 2xl:ml-[37px] -rotate-[5deg] 2xl:rotate-[9deg] "
            />
            <img
              src="/home/4.svg"
              alt=""
              className=" w-[230px] 2xl:w-[250px]  h-[230px] 2xl:h-[280px] mt-[30px] rotate-[20deg] mr-[73px] 2xl:hidden 2xl:mr-[52px] 2xl:rotate-[15deg] "
            />
          </div>
