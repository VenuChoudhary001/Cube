    ...
    <>
      ...
      >
        <div className="text-lg  flex gap-8 items-center">
          ...
          <Link
            href="/contact"
            className={`block flex items-start justify-center flex-col ${
          ...
          <span className={`block ${router.pathname == "/" && "anim_active"}`}>
            Press
          </span>
        </div>
        <div className="absolute left-[48%]">
          <Link href={"/"}>
            <svg
              ...
              className={` text-white ${!dark ? " fill-black" : "fill-white"}`}
            >
              {" "}
